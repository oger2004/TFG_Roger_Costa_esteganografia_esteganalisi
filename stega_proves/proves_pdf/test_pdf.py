...
from stega.stega_pdf import hide_message_pdf, unhide_message_pdf
...
def controller_hide_message(path: str, encrypt: int, message: str, password: str):
    ...
    hide_message_pdf(path, path_out, encrypted_message, password)
...
def controller_unhide_message(path: str, password: str) -> str:
    ...
    ciphertext = unhide_message_pdf(path_out,password)
...
if __name__ == '__main__':
    ...
    try:
        ...
        path_in = os.path.join(base_dir, "prova1.pdf")
    ...
    try:
        ...
        path_in = os.path.join(base_dir, "prova2.pdf")
        print("Introdueix el path fitxer de text: " + path_in )
    ...
    try:
        ...
        path_in = os.path.join(base_dir, "prova3.pdf")
        print("Introdueix el path fitxer de text: " + path_in )
